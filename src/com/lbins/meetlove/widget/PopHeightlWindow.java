 ...
 * Time: 20:58
 */
public class PopHeightlWindow extends PopupWindow {
    ...
    public PopHeightlWindow(Activity context, final List<String> arrays1, final List<String> arrays2) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.pop_heightl, null);
        ...
        adapter2 = new ItemHeightlAdapter(arrays2, context);
...
//        btnSure.setOnClickListener(itemsOnClick);
        btnSure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickContentItemListener.onClickContentItem(0, 1, startage.getText().toString() + "," + endage.getText().toString());
            }
        });
