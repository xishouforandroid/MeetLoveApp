 ...
 */
public class PayEmpRzActivity extends BaseActivity implements View.OnClickListener,Runnable {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(PayEmpRzActivity.this, "支付结果确认中",
                                    Toast.LENGTH_SHORT).show();

                        } else {
                            // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                            Toast.makeText(PayEmpRzActivity.this, "支付失败",
                                    Toast.LENGTH_SHORT).show();
                ...
                case SDK_CHECK_FLAG: {
                    Toast.makeText(PayEmpRzActivity.this, "检查结果为：" + msg.obj,
                            Toast.LENGTH_SHORT).show();
                    break;
                }
                default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeetLoveApplication.is_dxk_order = "0";
        initView();
    }
                        ...
                        if (StringUtil.isJson(s)) {
                            ...
                            try {
                                ...
                                if (code.equals("200")) {
                                    ...
                                    // 启动一个线程
                                    new Thread(PayEmpRzActivity.this).start();
                                }else{
                                    showMsg(PayEmpRzActivity.this, jo.getString("message"));
                                }
                            } catch (JSONException e) {
